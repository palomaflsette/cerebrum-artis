#!/usr/bin/env python3
"""
Deep-Mind V3: Adaptive Fuzzy-Neural Gating (IMPROVED)
======================================================
...
# ============================================================================
# MODEL V3: Adaptive Fuzzy Gating (EXTERNAL fuzzy inference)
# ============================================================================
...
# ============================================================================
# FUZZY INFERENCE (batch processing - EXTERNAL)
# ============================================================================

def batch_fuzzy_inference(fuzzy_system, fuzzy_features_batch):
    """Run fuzzy inference on batch (external to model)"""
...
def adaptive_fusion(neural_logits, fuzzy_probs, 
    ...
    # Adaptive alpha: high agreement → lower alpha (more fuzzy weight)
...
def train_epoch(model, fuzzy_system, dataloader, criterion, optimizer, device):
    ...
    return {
        ...
        'recall': recall_macro,
        'agreement': avg_agreement / n_batches
    }


def validate(model, fuzzy_system, dataloader, criterion, device, verbose=False):
    model.eval()
...
def main():
    print("=" * 80)
    print("🧠 DEEP-MIND V3 (IMPROVED): ADAPTIVE FUZZY-NEURAL GATING")
    print("=" * 80)
    ...
    checkpoint_dir = '/data/paloma/deep-mind-checkpoints/v3_adaptive_gating'
    ...
    model = FuzzyGatingClassifier(
        num_classes=9,
        dropout=0.3,
        freeze_resnet=True
    ).to(device)
    
    print(f"✅ V3 model created\n")
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        # Train
        train_metrics = train_epoch(model, fuzzy_system, train_loader, criterion, optimizer, device)
        
        # Validate
        val_metrics = validate(model, fuzzy_system, val_loader, criterion, device, verbose=(epoch % 5 == 0))
