#!/usr/bin/env python3
"""
Deep-Mind V3.1: Integrated Fuzzy-Neural Gating (IMPROVED)
==========================================================
...
- ✅ LR Scheduler mantido (ReduceLROnPlateau)
"""
...
# ============================================================================
# MODEL V3.1: INTEGRATED Fuzzy-Neural Gating
# ============================================================================

class IntegratedFuzzyGatingClassifier(nn.Module):
    """V3.1: Fuzzy system DENTRO do modelo"""
    ...
    def _adaptive_fusion(self, neural_logits, fuzzy_probs):
        """Adaptive fusion with agreement-based gating"""
...
def main():
    print("=" * 80)
    print("🧠 DEEP-MIND V3.1 (IMPROVED): INTEGRATED FUZZY-NEURAL GATING")
    print("=" * 80)
    ...
    with open(log_file, 'a') as f:
        f.write(f"\n{'='*80}\n")
        f.write(f"V3.1 Training Started: {datetime.now()}\n")
        f.write(f"{'='*80}\n\n")
